...
module.exports = function(grunt) {
    ...
    compress: {
      main: {
        ...
        files: [
          ...
          {
            flatten: true,
            src: ['dist/<%= pkg.name %>.jsx', 'dist/docs/**']
  ...
  grunt.registerTask('build', ['file-creator:basic','execute:helptext','concat:scripts', 'wrap:script', 'copy:script', 'markdown:all', 'copy:docs', 'compress:main']);
